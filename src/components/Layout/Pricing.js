...
const Pricing = () => {
    return (
        <div>
            <body className="h-full py-16 antialiased bg-primary-very-light font-sans">
    ...
    >
      ...
      >
        ...
        <ul className="text-sm font-bold">
          ...
          <li className="pt-3 pb-4 border-b border-gray-300">2 Users Allowed</li>
          <li className="pt-4 pb-4 border-b border-gray-300">Send up to 3 GB</li>
        </ul>
        <button
